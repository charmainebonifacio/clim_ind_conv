...
Function CheckFolderExists(ByVal fileDir As String) As Boolean
    ...
    Else: Debug.Print "Folder does not exists."
    End If
...
' Organization : Department of Geography, University of Lethbridge
' Title        : SaveAsCSV
' Description  : This function saves file as .CSV.
' Parameters   : Workbook, String, String
' Returns      : -
'---------------------------------------------------------------------
Function SaveAsCSV(wbTmp As Workbook, ByVal fileDir As String, _
